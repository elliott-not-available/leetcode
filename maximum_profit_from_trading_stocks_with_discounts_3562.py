# https://leetcode.com/problems/maximum-profit-from-trading-stocks-with-discounts/solutions/7416885/python3-solution-beats-95-tree-traversal-21x9/?envType=daily-question&envId=2025-12-16
from collections import defaultdict
from functools import lru_cache
class Solution:
    def maxProfit(self, 
                  n: int, present: list[int], future: list[int], 
        ...
        def d(employee, has_discount):
            ...
            for child in adj_list[employee]:
                child_with_discount = d(child, True)
                child_no_discount = d(child, False)
